...
<picture>
  <source media="(prefers-color-scheme: dark)" srcset="assets/hero-now-dark.svg?v=mu3h9jhd">
  <img src="assets/hero-now.svg?v=mu3h9jhd" width="100%" alt="Rakshit Hooda — full-stack developer, jack of too many trades, coding at night with headphones on" />
</picture>
...
<picture>
  <source media="(prefers-color-scheme: dark)" srcset="assets/anim/today-dark.svg?v=mu3h9jhd">
  <img src="assets/anim/today.svg?v=mu3h9jhd" width="100%" alt="Today's contribution animation" />
</picture>

<br /><br />

<picture>
  <source media="(prefers-color-scheme: dark)" srcset="assets/streak-dark.svg?v=mu3h9jhd">
  <img src="assets/streak.svg?v=mu3h9jhd" width="100%" alt="The last 12 months as one bar per day, with the current and longest streaks" />
</picture>
...
<!-- building:start -->
- **[TraceFall](https://github.com/rkhooda/TraceFall)** `Python` — update Vite proxy configuration to support dynamic API target · _8h ago_
