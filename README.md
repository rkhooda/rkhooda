...
<picture>
  <source media="(prefers-color-scheme: dark)" srcset="assets/hero-now-dark.svg?v=mtzigpay">
  <img src="assets/hero-now.svg?v=mtzigpay" width="100%" alt="Rakshit Hooda — full-stack developer, jack of too many trades, coding at night with headphones on" />
</picture>
...
<picture>
  <source media="(prefers-color-scheme: dark)" srcset="assets/anim/today-dark.svg?v=mtzigpay">
  <img src="assets/anim/today.svg?v=mtzigpay" width="100%" alt="Today's contribution animation" />
</picture>

<br /><br />

<picture>
  <source media="(prefers-color-scheme: dark)" srcset="assets/streak-dark.svg?v=mtzigpay">
  <img src="assets/streak.svg?v=mtzigpay" width="100%" alt="The last 12 months as one bar per day, with the current and longest streaks" />
</picture>
...
<!-- building:start -->
- **[TraceFall](https://github.com/rkhooda/TraceFall)** `Python` — add case deletion option in dashboard and case detail page · _12h ago_
- **[VectorFlow](https://github.com/rkhooda/VectorFlow)** `Python` — Clean integration imports · _14h ago_
