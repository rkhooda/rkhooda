...
<picture>
  <source media="(prefers-color-scheme: dark)" srcset="assets/hero-now-dark.svg?v=muamg31h">
  <img src="assets/hero-now.svg?v=muamg31h" width="100%" alt="Rakshit Hooda — full-stack developer, jack of too many trades, coding at night with headphones on" />
</picture>
...
<picture>
  <source media="(prefers-color-scheme: dark)" srcset="assets/anim/today-dark.svg?v=muamg31h">
  <img src="assets/anim/today.svg?v=muamg31h" width="100%" alt="Today's contribution animation" />
</picture>

<br /><br />

<picture>
  <source media="(prefers-color-scheme: dark)" srcset="assets/streak-dark.svg?v=muamg31h">
  <img src="assets/streak.svg?v=muamg31h" width="100%" alt="The last 12 months as one bar per day, with the current and longest streaks" />
</picture>
...
<!-- building:start -->
- **[music-app](https://github.com/rkhooda/music-app)** `TypeScript` — fix(frontend): handle URL origin polyfill on Android & commit backend… · _6h ago_
