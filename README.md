...
<img src="assets/hero-now.svg?v=mswaumq4" width="100%" alt="Rakshit Hooda — full-stack developer, jack of too many trades, coding at night with headphones on" />
...
<img src="assets/anim/today.svg?v=mswaumq4" width="100%" alt="Today's contribution animation" />

<br /><br />

<img src="assets/streak.svg?v=mswaumq4" width="100%" alt="Contributions this year, current streak and longest streak" />
...
<!-- building:start -->
- **[Clixo](https://github.com/rkhooda/Clixo)** `TypeScript` — fix(ui): fix custom cursor visibility on dark background · _1h ago_
- **[Portfolio](https://github.com/rkhooda/Portfolio)** `JavaScript` — fix: nav pill only follows active/focused section, not hover · _2h ago_
...
<img src="assets/wakatime.svg?v=mswaumq4" width="100%" alt="Where my last 7 days of coding went" />
