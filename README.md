...
<picture>
  <source media="(prefers-color-scheme: dark)" srcset="assets/hero-now-dark.svg?v=mugoxw3y">
  <img src="assets/hero-now.svg?v=mugoxw3y" width="100%" alt="Rakshit Hooda — full-stack developer, jack of too many trades, coding at night with headphones on" />
</picture>
...
<picture>
  <source media="(prefers-color-scheme: dark)" srcset="assets/anim/today-dark.svg?v=mugoxw3y">
  <img src="assets/anim/today.svg?v=mugoxw3y" width="100%" alt="Today's contribution animation" />
</picture>

<br /><br />

<picture>
  <source media="(prefers-color-scheme: dark)" srcset="assets/streak-dark.svg?v=mugoxw3y">
  <img src="assets/streak.svg?v=mugoxw3y" width="100%" alt="The last 12 months as one bar per day, with the current and longest streaks" />
</picture>
...
<!-- building:start -->
- **[Credence](https://github.com/rkhooda/Credence)** `Solidity` — Fix SIH dashboard wallet session · _41m ago_
